    ...
    <div className="md:p-10">
      ...
      <div className="border-2  border-red-500 md:p-10 p-3 rounded-tl-3xl rounded-br-3xl mt-10">
        <p className="md:text-lg text-xs">
          ...
          adipisci temporibus atque. Fuga aperiam facilis rem recusandae
          aliquid, porro sint voluptas eos tenetur pariatur! Doloribus nobis
          consequuntur dicta nisi repudiandae est facere, eveniet minima id,
          dolor magni aspernatur. Laudantium voluptas consectetur optio illo
          aspernatur aliquam provident nihil ullam consequuntur excepturi,
          labore quas adipisci explicabo quis perferendis expedita distinctio
          fugiat deleniti laboriosam quibusdam delectus. Corrupti veritatis id
          debitis impedit eius nulla? Eaque, et. Necessitatibus exercitationem
          ex excepturi inventore labont.
        </p>
      </div>
    </div>
  );
